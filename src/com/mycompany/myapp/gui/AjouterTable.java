...
public class AjouterTable extends BaseForm{
    ...
    public AjouterTable(Resources res,Form previous,Table fi) {
       ...
       Tabs swipe = new Tabs();
        ...
        RadioButton mesTables = RadioButton.createToggle("Mes Reclamations", barGroup);
        mesTables.setUIID("SelectBar");
       
        Label arrow = new Label(res.getImage("news-tab-down-arrow.png"), "Container");
        
      
      mesTables.addActionListener((e) -> {
        ...
        add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(3, mesTables),
                FlowLayout.encloseBottom(arrow)
        ));

      mesTables.setSelected(true);
        arrow.setVisible(false);
        addShowListener(e -> {
            arrow.setVisible(true);
            updateArrowPosition(mesTables, arrow);
        });
        bindButtonSelection(mesTables, arrow);
        ...
        addStringValue("Description",nbChaises);
        
         TextField stock = new TextField("", "entrer nombre stock!!");
        stock.setUIID("TextFieldBlack");
        addStringValue("Description",stock);
